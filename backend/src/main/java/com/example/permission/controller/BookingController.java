...
public class BookingController {
    ...
    public ResponseEntity<byte[]> exportBookings(@RequestBody Map<String, Object> params,
        ...
        List<Booking> bookings = bookingService.exportBookings(bookingNo, customerId, customerName,
    ...
    public Result<BigDecimal> calculatePrice(
        ...
        BigDecimal result = bookingService.calculatePrice(roomType, checkInDate, checkOutDate,
